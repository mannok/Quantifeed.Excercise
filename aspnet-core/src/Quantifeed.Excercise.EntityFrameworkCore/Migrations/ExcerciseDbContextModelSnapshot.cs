...
namespace Quantifeed.Excercise.Migrations
{
    ...
    partial class ExcerciseDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Quantifeed.Excercise.Business.Baskets.Basket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Quantifeed.Excercise.Business.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Quantifeed.Excercise.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Quantifeed.Excercise.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Quantifeed.Excercise.Business.Orders.Order", b =>
                {
                    b.HasOne("Quantifeed.Excercise.Business.Baskets.Basket", "Basket")
