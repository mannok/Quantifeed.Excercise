...
{
    public abstract class ExcerciseWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ExcerciseWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ExcerciseWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ExcerciseDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ExcerciseDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ExcerciseDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ExcerciseDbContext, Task<T>> func)
        {
            T result;
